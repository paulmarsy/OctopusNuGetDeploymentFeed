...
namespace OctopusDeployNuGetFeed.DataServices
{
    public class QueryResult<TModel> : IHttpActionResult
    {
        ...
        public QueryResult(
            ODataQueryOptions<TModel> queryOptions, IQueryable<TModel> queryable, ApiController controller, int maxPageSize,
            long? totalResults, Func<ODataQueryOptions<TModel>, ODataQuerySettings, long?, Uri> generateNextLink)
        {
            ...
            _querySettings = new ODataQuerySettings(DefaultQuerySettings)
            {
            ...
            if (_isPagedResult && _generateNextLink != null && _totalResults.HasValue)
            {
                ...
                if (queryOptions.OrderBy != null
                    && !(
                        ...
                        queryOptions.OrderBy.OrderByClause.ItemType.Definition.TypeKind != EdmTypeKind.Primitive
